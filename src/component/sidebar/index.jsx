            ...
            <ul className="mt-2.5">
              ...
              >
                ...
                >
                  <li>
                    <Link
                      to="/bankmanagement?status=Pending"
                      className={`text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300 ${location === "/home-2" ? "nav-active" : ""
                        }`}
                    >
                      Pending
              ...
              <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/statemanagement" ? "nav-active" : ""
                  } `}
              >
                <Link to="/statemanagement">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      <span className="item-ico">
                        <svg
              ...
              <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/gamelogic" ? "nav-active" : ""
                  } `}
              >
                <Link to="/gamelogic">
                  <div className="flex items-center justify-between">
              ...
              <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/paymentConfig" ? "nav-active" : ""
                  } `}
              >
                <Link to="/paymentConfig">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      <span className="item-ico">
                        <svg
