...
import CustomerInfo from "./UserInfostate";
import users from "../../data/user";
import offerContext from '../../context/offerContext'
import React,{useContext,useEffect,useState,useRef} from 'react';

function UserTabstate({ }) {
  ...
  const { latatestUserStatewise } = context
  ...
  useEffect( () => {
    const submitdata = async () => {
      setJsonData(await latatestUserStatewise())
    }
  submitdata()
  },[]);
...
UserTabstate.propTypes = {
  pageSize: ProtoTypes.number,
};

export default UserTabstate;
